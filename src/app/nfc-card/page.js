...
export default function NFCPage() {
  ...
  return (
    <div className="bg-white">
      ...
      <PrintAndDeliver
        heading="Print & Deliver"
        description="Our technology serves professionals across all industries looking to make meaningful connections."
        deliveryText="We don’t just design smart cards—we print and deliver them right to your doorstep! We guarantee excellent print quality, personalized branding, and safe packing whether you're ordering a single NFC card or a large quantity of contactless cards for local businesses. We take care of printing, encoding, and delivery after your design is complete."
        mainImage="/images/delivery-main.jpg"
