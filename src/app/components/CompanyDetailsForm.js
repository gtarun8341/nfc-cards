...
const CompanyDetailsForm = ({ onDataChange, initialData }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl border border-gray-200">
      <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Company Details</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[
          ...
          { label: "Contact Number 1", name: "contact1", type: "text", required: true },
          { label: "Contact Number 2", name: "contact2", type: "text", required: false },
          { label: "WhatsApp Number 1", name: "whatsapp1", type: "text", required: true },
          { label: "WhatsApp Number 2", name: "whatsapp2", type: "text", required: false },
          { label: "Email", name: "email", type: "email", required: true },
          { label: "Website", name: "website", type: "url", required: false },
          { label: "Google Map Link", name: "googleMap", type: "text", required: false },
