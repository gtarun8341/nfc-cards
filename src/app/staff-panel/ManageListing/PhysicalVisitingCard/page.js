...
const AdminPhysicalVisitingCardPage = () => {
    ...
    useEffect(() => {
        const fetchTemplates = async () => {
            try {
                ...
                const response = await api.get('/api/templates/staff/templates?type=physical-visiting-card', config);
    ...
    const previewTemplate = async (templateId) => {
        try {
            ...
            const response = await api.get(`/api/templates/staff/render/${templateId}?type=physical-visiting-card`, config);
    ...
    //         await api.delete(`/api/templates/${templateId}?type=physical-visiting-card`, config);
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-2xl font-bold mb-4">Staff - Manage physical-visiting-card Templates</h1>
...
export default AdminPhysicalVisitingCardPage;
