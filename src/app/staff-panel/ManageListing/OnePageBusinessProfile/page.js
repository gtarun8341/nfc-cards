...
const AdminOnePageBusinessProfilePage = () => {
    ...
    useEffect(() => {
        const fetchTemplates = async () => {
            try {
                ...
                const response = await api.get('/api/templates/staff/templates?type=one-page-business-profile', config);
    ...
    const previewTemplate = async (templateId) => {
        try {
            ...
            const response = await api.get(`/api/templates/staff/render/${templateId}?type=one-page-business-profile`, config);
    ...
    //         await api.delete(`/api/templates/${templateId}?type=one-page-business-profile`, config);
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-2xl font-bold mb-4">Staff - Manage one-page-business-profile Templates</h1>
...
export default AdminOnePageBusinessProfilePage;
