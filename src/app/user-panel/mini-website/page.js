...
const MiniWebsitePage = () => {
    ...
    useEffect(() => {
        const fetchTemplates = async () => {
            try {
                ...
                const response = await api.get('/api/templates/templates?type=mini-website', config);
    ...
    const previewTemplate = async (templateId) => {
        try {
            ...
            const response = await api.get(`/api/templates/render/${templateId}?type=mini-website`, config);
    ...
    const handleSelectTemplate = async (templateId) => {
        try {
            ...
            const response = await api.post('/api/selectedtemplates/select?type=mini-website', { templateId }, config);
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-3xl font-bold text-center mb-6 text-blue-600">Available Mini Website Templates</h1>
...
export default MiniWebsitePage;
