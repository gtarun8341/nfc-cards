...
const PDFVisitingCardPage = () => {
    ...
    useEffect(() => {
        const fetchTemplates = async () => {
            try {
                ...
                const response = await api.get('/api/templates/templates?type=pdf', config);
    ...
    const previewTemplate = async (templateId) => {
        try {
            ...
            const response = await api.get(`/api/templates/render/${templateId}?type=pdf`, config);
    ...
    const handleSelectTemplate = async (templateId) => {
        try {
            ...
            const response = await api.post('/api/selectedtemplates/select?type=pdf', { templateId }, config);
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-3xl font-bold text-center mb-6 text-blue-600">Available PDF Visiting Card Templates</h1>
...
export default PDFVisitingCardPage;
