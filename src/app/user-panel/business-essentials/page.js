...
const BusinessEssentialsPage = () => {
  ...
  const fetchTemplates = async () => {
    try {
      ...
      const response = await api.get(
        `/api/templates/templates?type=business-essentials&page=${page}&limit=9`,
        config
      );
      ...
      const selectedTemplatesResponse = await api.get(
        "/api/selectedtemplates/link?type=business-essentials",
        config
      );
      console.log(
  ...
  const previewTemplate = async (templateId) => {
    try {
      ...
      const response = await api.get(
        `/api/templates/render/${templateId}?type=business-essentials`,
        config
      );
  ...
  const handleSelectTemplate = async (templateId) => {
    try {
      ...
      const response = await api.post(
        "/api/selectedtemplates/select?type=business-essentials",
        { templateId },
        config
      );
      setSelectedTemplateData({
  ...
  const handleDeleteSelectedTemplate = async () => {
    try {
      ...
      await api.post(
        "/api/selectedtemplates/delete?type=business-essentials",
        {},
        config
      );
