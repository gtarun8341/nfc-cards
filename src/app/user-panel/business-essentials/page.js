...
const BusinessEssentialsPage = () => {
    ...
    useEffect(() => {
        const fetchTemplates = async () => {
            try {
                ...
                const response = await api.get('/api/templates/templates?type=business-essentials', config);
    ...
    const previewTemplate = async (templateId) => {
        try {
            ...
            const response = await api.get(`/api/templates/render/${templateId}?type=business-essentials`, config);
    ...
    const handleSelectTemplate = async (templateId) => {
        try {
            ...
            const response = await api.post('/api/selectedtemplates/select?type=business-essentials', { templateId }, config);
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-3xl font-bold text-center mb-6 text-blue-600">Available Business Essentials Templates</h1>
