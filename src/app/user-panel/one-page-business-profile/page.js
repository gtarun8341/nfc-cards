...
const OnePageBusinessProfilePage = () => {
    ...
    const handleSelectTemplate = async (templateId) => {
        try {
            ...
            const response = await api.post('/api/selectedtemplates/select?type=one-page-business-profile', { templateId }, config);
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-3xl font-bold text-center mb-6 text-blue-600">Available one page business profile Templates</h1>
